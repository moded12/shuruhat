...
class TabBarDemo extends StatelessWidget {
 ...
 late String parahs_pages;
  TabBarDemo(String title,String Server,String file_name,String count,String ext,String surah_pages,String parahs_pages){
    this.title = title;
    this.Server=Server;
    ...
    return  DefaultTabController(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Center(child: Text(title,style: GoogleFonts.cairo(textStyle: TextStyle(
              color: Colors.white,
              fontSize: 22.0,
            )),)),
          ),
